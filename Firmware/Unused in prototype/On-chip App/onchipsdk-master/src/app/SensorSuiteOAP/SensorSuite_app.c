...
// blue LED on DC9003A
#define PIN_TOGGLE      DN_GPIO_PIN_20_DEV_ID
...
int p2_init(void) {
   ...
   osErr = OSTaskCreateExt(
      gpioToggleTask,
      (void *) 0,
      (OS_STK*) (&join_app_vars.gpioToggleTaskStack[TASK_APP_GPIOTOGGLE_STK_SIZE-1]),
      TASK_APP_GPIOTOGGLE_PRIORITY,
      TASK_APP_GPIOTOGGLE_PRIORITY,
      (OS_STK*) join_app_vars.gpioToggleTaskStack,
